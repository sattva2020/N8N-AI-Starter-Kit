...
- [Установка](#установка)
  - [Быстрая установка](#быстрая-установка-рекомендуется)
...
- [Мониторинг и аналитика](#система-мониторинга-и-аналитики)
- [Интеграции](#настройка-учетных-данных-для-сервисов)
...
- [Шаблоны и примеры](#🛍️-шаблоны-и-примеры)
