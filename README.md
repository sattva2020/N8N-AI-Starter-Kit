...
**Май 2025 (v1.0.1)**: Комплексные улучшения производительности и стабильности:
- Добавлены ресурсные лимиты для всех контейнеров
- Исправлена ошибка "concurrent map writes" при запуске Docker Compose
- Оптимизирована конфигурация Zep и Neo4j для лучшей производительности
- Обновлены скрипты запуска для большей стабильности

[Подробнее о версии 1.0.1](./docs/CHANGELOG.md) | [Руководство по документации](./docs/DOCUMENTATION_GUIDE.md) | [Распространенные проблемы](./docs/COMMON_ISSUES.md) | [Руководство по установке](./docs/SETUP_SCRIPT.md)
