...
**Май 2025 (v1.0.4)**: Интеграция Ollama entrypoint, улучшения документации и шаблонов.
...
- Интегрирован локальный логотип `N8N AI Starter Kit Logo.jpeg`
- Обновлены переменные окружения и шаблон `template.env`
...
<p align="center">
  <img src="img/N8N AI Starter Kit Logo.jpeg" alt="N8N AI Starter Kit Logo" width="300">
</p>
...
```powershell
# Клонирование репозитория с конкретной версией
git clone --branch v1.0.2 https://github.com/sattva2020/N8N-AI-Starter-Kit.git
...
git clone --branch v1.0.3 https://github.com/sattva2020/N8N-AI-Starter-Kit.git
cd N8N-AI-Starter-Kit
...
При установке N8N AI Starter Kit рекомендуется использовать стабильные теги (например, v1.0.1 или v1.0.2) вместо ветки `main`, которая может содержать экспериментальные изменения.
