...
[Подробнее о майском обновлении](./docs/MAY_2025_UPDATE.md) | [Решение проблемы с хешем пароля Traefik](./docs/TRAEFIK_PASSWORD_FIX.md) | [Решение конфликта сетей](./docs/NETWORK_CONFLICT_FIX.md) | [Решение проблемы с переменными окружения](./docs/ENV_VARIABLES_FIX.md) | [Руководство по документации](./docs/DOCUMENTATION_GUIDE.md) | [Распространенные проблемы](./docs/COMMON_ISSUES.md)
...
- [Установка](#-установка)
  ...
  - [Запуск с исправлением проблем](#запуск-с-использованием-автоматического-исправления-проблем)
...
- [Система мониторинга и аналитики](#-система-мониторинга-и-аналитики-в-профиле-developer)
...
> [Руководство по документации](./docs/DOCUMENTATION_GUIDE.md) | [Устранение неполадок](TROUBLESHOOTING.md) | [Распространенные проблемы](./docs/COMMON_ISSUES.md)
...
| [📊 Мониторинг](#-система-мониторинга-и-аналитики-в-профиле-developer) | Система мониторинга и аналитики |
...
│   ├── 🛠️ ENV_VARIABLES_FIX.md     # Решение проблем с переменными окружения
│   ├── 📝 IMPROVEMENTS_SUMMARY.md  # Сводка улучшений проекта
│   ├── 📅 MAY_2025_UPDATE.md       # Информация о майском обновлении
│   ├── 🔗 NETWORK_CONFLICT_FIX.md  # Решение конфликтов в сетях Docker
│   ├── ⚙️ SETUP_SCRIPT_IMPROVEMENTS.md  # Улучшения в скрипте настройки
│   ├── 🧪 SETUP_SCRIPT_TESTING.md      # Тестирование скрипта настройки
│   ├── 📊 SETUP_SCRIPT_WORK_SUMMARY.md # Сводка работы скрипта настройки
│   ├── 🔐 TRAEFIK_PASSWORD_FIX.md      # Исправление проблем с паролем Traefik
...
- **supabase-compose.yml** — конфигурация для развертывания Supabase (альтернатива Firebase с открытым исходным кодом).
...
- **MAY_2025_UPDATE.md** — подробное описание обновлений, внесённых в мае 2025 года.
- **TRAEFIK_PASSWORD_FIX.md** — руководство по исправлению проблем с хешированием пароля Traefik.
- **NETWORK_CONFLICT_FIX.md** — инструкции по устранению конфликтов сетей Docker.
- **ENV_VARIABLES_FIX.md** — решение проблем с переменными окружения.
- **SETUP_SCRIPT_IMPROVEMENTS.md** — документация по улучшениям скрипта установки.
