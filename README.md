...
> [!NOTE]
> При использовании профиля `minimal` запускаются только основные компоненты, необходимые для работы n8n с локальным ИИ. Профиль `developer` включает все компоненты, включая инструменты мониторинга, аналитики и разработки.
...
О: Да, вы можете использовать профиль `minimal` для установки только основных компонентов или создать свой профиль в файле `docker-compose.yml`.
