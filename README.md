...
git clone --branch v1.0.7 https://github.com/sattva2020/N8N-AI-Starter-Kit.git
...
> **✨ Что нового в v1.0.7**: Скрипт `start.sh` теперь автоматически создает файл `.env` из `template.env` с безопасными сгенерированными паролями! Больше не нужно вручную создавать конфигурацию.
...
> [!TIP]  
> Настройте автоматические уведомления при превышении пороговых значений использования ресурсов.