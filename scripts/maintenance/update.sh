...
echo "- gpu        : Стандартный набор с поддержкой GPU"
echo ""
echo "Примечание: для AMD/ROCm используйте ./start.sh — он автоматически применит overlay compose/gpu-amd.override.yml"
