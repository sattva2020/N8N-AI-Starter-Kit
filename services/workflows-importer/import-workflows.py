#!/usr/bin/env python3
"""
N8N Workflows Auto-Importer v1.3.0
Автоматический импорт workflows из официального репозитория Zie619/n8n-workflows
...
class N8NWorkflowImporter:
    def __init__(self, n8n_url: str = "http://n8n:5678"):
        ...
        self.workflows_dirs = [
            Path("/workflows"),          # Workflows из официального репозитория Zie619/n8n-workflows
        ]
    ...
    def import_all_workflows(self) -> Dict[str, int]:
        ...
        for workflows_dir in self.workflows_dirs:
            ...
            def get_priority(file_path):
                """Определяем приоритет импорта для официального репозитория"""
                ...
                # Приоритет по типу workflow (адаптировано под официальный репозиторий)
                name_priority = 0
    ...
    def run(self):
        ...
        logger.info("🚀 N8N Workflows Auto-Importer v1.3.0")
        logger.info("📚 Источник: https://github.com/Zie619/n8n-workflows")
        logger.info("=" * 50)
